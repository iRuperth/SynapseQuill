...
def narrate(match: Match, *, language: str = "es", system_preamble: str = "",
    ...
    system = (system_preamble + "\n\n" if system_preamble else "") + (
        ...
        "(in Spanish: '¡GOL!', '¡QUÉ GOLAZO!', '¡INCREÍBLE!'; in English: 'GOAL!', 'WHAT A STRIKE!'). "
        "IMPORTANT: write 'GOL' / 'GOAL' normally — NEVER repeat the vowels "
        "('GOOOOL', 'GOOOAL'), because the text-to-speech reads repeated vowels as 'Go-ol', "
        "which sounds wrong. The excitement comes from the words and punctuation, not stretched letters.\n"
